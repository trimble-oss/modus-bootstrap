...
<input type="date" id="datetime" class="form-control" value="2026-02-24">
<br>
<label for="time" class="form-label">Time</label>
<input type="time" id="time" class="form-control" value="13:00">
<br>
<label for="month" class="form-label">Month</label>
<input type="month" id="datetime" class="form-control" value="2026-02">
<br>
<label for="week" class="form-label">Week</label>
<input type="week" id="datetime" class="form-control" value="2026-W09">
{{< /example >}}
