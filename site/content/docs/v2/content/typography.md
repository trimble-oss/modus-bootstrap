...
| Heading | Example |
| --- | --- |
| `<h1></h1>` | <span class="h1">h1. heading</span> |
| `<h2></h2>` | <span class="h2">h2. heading</span> |
| `<h3></h3>` | <span class="h3">h3. heading</span> |
| `<h4></h4>` | <span class="h4">h4. heading</span> |
| `<h5></h5>` | <span class="h5">h5. heading</span> |
| `<h6></h6>` | <span class="h6">h6. heading</span> |
{{< /bs-table >}}
...
In Modus Bootstrap v2, we've enabled responsive font sizes by default, allowing text to scale more naturally across device and viewport sizes. Have a look at the [RFS page]({{< docsref "/getting-started/rfs" >}}) to find out how this works.
...
There are no dedicated mixins for typography, but Modus Bootstrap does use [Responsive Font Sizing (RFS)]({{< docsref "/getting-started/rfs" >}}).
