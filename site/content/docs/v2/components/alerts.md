...
Need more than one icon for your alerts? Consider using more Modus Icons and making a local SVG sprite like so to easily reference the same icons repeatedly.
