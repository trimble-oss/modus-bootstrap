...
Add the `.nav-tabs` class to a `.nav` to generate a tabbed interface. Use them to create tabbable regions with our [tab JavaScript plugin](#javascript-behavior).
...
To use smaller variants of tabs, add the `.nav-tabs-sm` modifier class.
