...
layout: docs
title: Navbar
description: Documentation and examples for Modus Bootstrap's powerful, responsive navigation header, the navbar. Includes support for branding, navigation, and more, including support for our collapse plugin.
group: components
toc: true
aliases:
  - "/components/navbar/"
...
<nav class="navbar">
  <div class="container">
    <a class="navbar-brand" href="#">
      <img src="/docs/{{< param docs_version >}}/assets/brand/trimble-icon.svg" alt="" width="30" height="24">
    </a>
  </div>
</nav>
{{< /example >}}
...
<nav class="navbar">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="/docs/{{< param docs_version >}}/assets/brand/trimble-icon.svg" alt="" width="30" height="24" class="d-inline-block align-text-top">
      Trimble
    </a>
  </div>
</nav>
...
{{< example >}}
<nav class="navbar navbar-expand-lg navbar-blue" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Navbar</a>
...
Navbar themes are easier than ever thanks to Modus Bootstrap's combination of Sass and CSS variables. The default is our "light navbar" for use with light background colors, but you can also apply `.navbar-dark` for dark background colors. Then, customize with `.bg-*` utilities.
...
{{< example >}}
<nav class="navbar-tertiary fixed-top">
  <div class="container-fluid">
...
As part of Modus Bootstrap's evolving CSS variables approach, navbars now use local CSS variables on `.navbar` for enhanced real-time customization. Values for the CSS variables are set via Sass, so Sass customization is still supported, too.
