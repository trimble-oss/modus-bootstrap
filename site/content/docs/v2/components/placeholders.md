...
<span class="placeholder placeholder-wave" style="width: 25%;"></span>
{{< /example >}}
...
{{< example >}}
<span class="placeholder placeholder-wave col-12 placeholder-lg"></span>
<span class="placeholder placeholder-wave col-12"></span>
<span class="placeholder placeholder-wave col-12 placeholder-sm"></span>
<span class="placeholder placeholder-wave col-12 placeholder-xs"></span>
{{< /example >}}

### Animation

Animate placeholders with `.placeholder-wave` to better convey the perception of something being *actively* loaded.

{{< example >}}
<p class="placeholder-wave">
  <span class="placeholder py-5 col-12"></span>
</p>
{{< /example >}}
