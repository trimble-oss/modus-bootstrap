...
<a class="icon-link" href="#">
  <i class="modus-icons notranslate small" aria-hidden="true">antenna</i>
  Icon link
</a>
{{< /example >}}
...
<a class="icon-link" href="#">
  RSS Feed
  <i class="modus-icons notranslate small" aria-hidden="true">rss_feed</i>
</a>
{{< /example >}}
...
<a class="icon-link icon-link-hover" href="#">
  Icon link
  <i class="modus-icons notranslate small" aria-hidden="true">filter_list</i>
</a>
{{< /example >}}
...
<a class="icon-link icon-link-hover" style="--bs-link-hover-color-rgb: 25, 135, 84;" href="#">
  Icon link
  <i class="modus-icons notranslate small" aria-hidden="true">arrow_right</i>
</a>
{{< /example >}}
